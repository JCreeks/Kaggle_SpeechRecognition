...
class SC_Config:
    def __init__(self, mode='train'):
        ...
        self.seed = 24
        self.paths_test = glob(os.path.join('../input', 'test/audio/*wav'))
        self.dir_noise = '../input/data_augmentation/silence/artificial_silence/'
        ...
        self.dir_art_unknown = '../input/data_augmentation/unknown/artificial_unknown/'
    ...
    def data_gen(self):
        if self.config.mode == 'train':
            ...
            for _ in range(int(self.config.amount_silence * self.config.pure_silence_portion)):
                data.append((self.config.name2id['silence'], '', '../input/data_augmentation/silence/pure_silence.wav'))
