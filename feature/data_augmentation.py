...
train_dir = '../input/train/audio/'
test_dir = '../input/test/audio/'
bn_dir = '../input/train/audio/_background_noise_/'
save_dir_background = '../input/data_augmentation/silence/background/'
save_dir_silence = '../input/data_augmentation/silence/artificial_silence/'
save_dir_unknown = '../input/data_augmentation/unknown/artificial_unknown/'
